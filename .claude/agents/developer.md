...
- Instagram: max 2,200 characters, caption pairing with the image card, hook line + short context + CTA + `[LINK]` placeholder (link-in-bio note)
...
- [ ] social-posts.md — Twitter / LinkedIn / Threads / Instagram
