...
- Instagram caption (2,200 chars max): pairs with the image card; hook line + short context + CTA + link-in-bio note
...
- [ ] All 4 social posts formatted correctly (Twitter/X, LinkedIn, Threads, Instagram)
